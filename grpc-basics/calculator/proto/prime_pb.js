...
proto.calculator.PrimeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    requestNumber: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * @return {number}
 */
proto.calculator.PrimeRequest.prototype.getRequestNumber = function() {
 ...
 */
proto.calculator.PrimeRequest.prototype.setRequestNumber = function(value) {
